  ...
  try {
    ...
    await Promise.all([
      ...
      userRepository.save(userRepository.create({
        ...
        email: "martina.presi@gmail.cl",
        password: await encryptPassword("presi2024"),
        rol: "presidenta",
        estado_activo: true,
        fecha_registro: now,
      })),
      userRepository.save(userRepository.create({
        ...
        email: "leo.secre@gmail.cl",
        password: await encryptPassword("secre2024"),
        rol: "secretaria",
        estado_activo: true,
        fecha_registro: now,
      })),
      userRepository.save(userRepository.create({
        ...
        email: "camila.teso@gmail.cl",
        password: await encryptPassword("teso2024"),
        rol: "tesorera",
        estado_activo: true,
        fecha_registro: now,
      })),
