...
router
  ...
  .delete("/detail/", authorizeRoles("admin","presidenta", "secretario", "tesorera"), deleteNotificacionAlerta)
  .post("/", authorizeRoles("admin","presidenta", "secretario", "tesorera"), createNotificacionAlerta);
